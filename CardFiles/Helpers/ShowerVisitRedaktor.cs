...
{
    public class ShowerVisitRedaktor
    {
        public static int acceptChanges;
        public static void Show(VisitRedaktorViewModel model)
        {
            VisitRedaktorControl control = new VisitRedaktorControl() { DataContext = model };
            if (control != null)
            {
